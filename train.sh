...
# python main_cls.py --task test --config configs/sta_reg3.yml
python main_cls.py --task test --config configs/sta_joint2.yml
# python main_cls.py --task vis --config configs/sta_gen2.yml